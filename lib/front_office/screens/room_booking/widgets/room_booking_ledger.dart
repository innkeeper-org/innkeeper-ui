...
class RoomBookingLedger extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    BillingAccount billingAccount =
        BillingAccountRepository.getDefaultBillingAccount(
            roomBooking: roomBooking);
    ...
    for (Charge charge in billingAccount.chargeList) {
      chargesList.add(TableRow(children: [
        Text((chargesList.length).toString(),
        ...
        Text(charge.price.priceWithoutTax.toStringAsFixed(2),
            style: theme.textTheme.bodyMedium),
        Text(charge.price.taxRate.toString(),
            style: theme.textTheme.bodyMedium),
        Text("-", style: theme.textTheme.bodyMedium),
        Text(charge.price.getAmount().toStringAsFixed(2),
            style: theme.textTheme.bodyMedium)
      ]));
    }
    ...
    for (Payment payment in billingAccount.paymentList) {
      paymentList.add(TableRow(children: [
